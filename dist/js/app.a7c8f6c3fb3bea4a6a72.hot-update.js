...
function (_React$Component) {
  ...
  _createClass(Validator, [{
    ...
    value: function numericalValueChange(e) {
      ...
      this.setState({
        showNumericError: false,
        numericalValue: parseInt(e.target.value * 10).toFixed(2)
      });
      this.validate();
    }
  }, {
    ...
    value: function studentResponseChange(e) {
      ...
      this.setState({
        showStudentResponseError: false,
        studentResponse: parseInt(e.target.value * 10).toFixed(2)
      });
      this.validate();
    }
  }, {
...
//# sourceMappingURL=app.a7c8f6c3fb3bea4a6a72.hot-update.js.map