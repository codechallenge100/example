...
function (_React$Component) {
  ...
  _createClass(Validator, [{
    ...
    value: function numericalValueChange(e) {
      ...
      this.setState({
        showNumericError: false,
        numericalValue: parseInt(e.target.value * 10 / 10).toFixed(2)
      });
      this.validate();
    }
  }, {
    ...
    value: function studentResponseChange(e) {
      ...
      this.setState({
        showStudentResponseError: false,
        studentResponse: parseInt(e.target.value * 10 / 10).toFixed(2)
      });
      this.validate();
    }
  }, {
...
//# sourceMappingURL=app.0cf1d3309ef4f0f40695.hot-update.js.map