...
function (_React$Component) {
  ...
  function Validator(props) {
    ...
    _this.state = (_this$state = {
      ...
      optionsTarget: []
    }, _defineProperty(_this$state, "valid", false), _defineProperty(_this$state, "disabled", true), _defineProperty(_this$state, "numericalValue", 0), _defineProperty(_this$state, "studentResponse", 0), _this$state);
  ...
  _createClass(Validator, [{
    ...
    value: function numericalValueChange(e) {
      ...
      if (!this.numericValidate(e.target.value)) {
        ...
        this.setState({
          showNumericError: false,
          numericalValue: Math.max(Math.round(parseInt(e.target.value) * 10) / 10).toFixed(2)
        });
      }
    ...
    value: function studentResponseChange(e) {
      ...
      if (!this.numericValidate(e.target.value)) {
        ...
        this.setState({
          showStudentResponseError: false,
          studentResponse: Math.max(Math.round(parseInt(e.target.value) * 10) / 10).toFixed(2)
        });
      }
    ...
    value: function render() {
      ...
      }, "Grade"), this.state.valid ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", {
        className: "correct"
...
//# sourceMappingURL=app.f5313761c8d10df3e6ef.hot-update.js.map