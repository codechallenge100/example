...
function (_React$Component) {
  ...
  _createClass(Validator, [{
    ...
    value: function numericalValueChange(e) {
      ...
      this.setState({
        showNumericError: false,
        numericalValue: Math.max(Math.round(parseInt(e.target.value) * 10) / 10)
      });
      this.validate();
    }
  }, {
    ...
    value: function studentResponseChange(e) {
      ...
      this.setState({
        showStudentResponseError: false,
        studentResponse: Math.max(Math.round(parseInt(e.target.value) * 10) / 10)
      });
      this.validate();
    }
  }, {
...
//# sourceMappingURL=app.d8378d50d619326eba7e.hot-update.js.map