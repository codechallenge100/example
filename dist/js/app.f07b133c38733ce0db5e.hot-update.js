...
function (_React$Component) {
  ...
  _createClass(Validator, [{
    ...
    value: function numericalValueChange(e) {
      ...
      this.setState({
        showNumericError: false,
        numericalValue: parseInt(parseFloat(e.target.value).toFixed(2))
      });
      this.validate();
    }
  }, {
    ...
    value: function studentResponseChange(e) {
      ...
      this.setState({
        showStudentResponseError: false,
        studentResponse: parseInt(parseFloat(e.target.value).toFixed(2))
      });
      this.validate();
    }
  }, {
...
//# sourceMappingURL=app.f07b133c38733ce0db5e.hot-update.js.map