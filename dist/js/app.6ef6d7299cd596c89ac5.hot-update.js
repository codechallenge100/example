...
function (_React$Component) {
  ...
  _createClass(Validator, [{
    ...
    value: function numericalValueChange(e) {
      ...
      this.setState({
        showNumericError: false,
        numericalValue: parseInt(e.target.value * 10).toFixed(1)
      });
      this.validate();
    }
  }, {
    ...
    value: function studentResponseChange(e) {
      ...
      this.setState({
        showStudentResponseError: false,
        studentResponse: parseInt(e.target.value * 10).toFixed(1)
      });
      this.validate();
    }
  }, {
...
//# sourceMappingURL=app.6ef6d7299cd596c89ac5.hot-update.js.map