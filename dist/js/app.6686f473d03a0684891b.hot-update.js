...
function (_React$Component) {
  ...
  _createClass(Validator, [{
    ...
    value: function numericalValueChange(e) {
      ...
      this.setState({
        showNumericError: false,
        numericalValue: Math.max(Math.round(parseInt(e.target.value) * 10) / 10).toFixed(1)
      });
      this.validate();
    }
  }, {
    ...
    value: function studentResponseChange(e) {
      ...
      this.setState({
        showStudentResponseError: false,
        studentResponse: Math.max(Math.round(parseInt(e.target.value) * 10) / 10).toFixed(1)
      });
      this.validate();
    }
  }, {
...
//# sourceMappingURL=app.6686f473d03a0684891b.hot-update.js.map