  ...
  _createClass(Validator, [{
    ...
    value: function grade() {
      switch (unitBeingMeasured) {
        case "fahrenheit":
          return this.convertFahrenheit(this.state.numericalValue, this.state.targetUnitOfMeasure);

        case "celsius":
          return this.convertCelsius(this.state.numericalValue, this.state.targetUnitOfMeasure);

        case "kelvin":
          return this.convertKelvin(this.state.numericalValue, this.state.targetUnitOfMeasure);

        case "rankine":
          return this.convertRankine(this.state.numericalValue, this.state.targetUnitOfMeasure);
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=app.52bac87c9dd4a9ffbce5.hot-update.js.map